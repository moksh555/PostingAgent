"""Shared authentication test configuration.

The service config is instantiated during module import, so set deterministic
defaults before tests import application modules.
"""
...
os.environ.setdefault(
    ...
    "test-access-secret-with-32-bytes-min",
)
os.environ.setdefault(
    "AUTHENTICATION_REFRESH_SECRET_KEY",
    "test-refresh-secret-with-32-bytes-min",
)
