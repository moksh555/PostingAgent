...
os.environ.setdefault("AUTHENTICATION_SECRET_KEY", "test-access-secret-with-32-byte-min")
os.environ.setdefault("AUTHENTICATION_REFRESH_SECRET_KEY", "test-refresh-secret-with-32-byte-min")
